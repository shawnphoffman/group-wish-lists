...
import { faCirclePlus } from '@awesome.me/kit-ac8ad9255a/icons/sharp-duotone/solid'
...
export default async function ImportItem() {
	...
	return (
		<div className="relative flex flex-col flex-1 w-full max-w-5xl gap-6 sm:px-3 max-md:gap-2 animate-page-in">
